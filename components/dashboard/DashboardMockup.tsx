...
export default function DashboardMockup() {
  return (
    <div className="relative w-full max-w-xl mx-auto select-none" aria-label="Revenue Autopilot dashboard preview">
      ...
      <div className="absolute -top-4 -right-4 bg-op-navy text-white rounded-xl shadow-lg px-4 py-2.5 flex flex-col items-center">
        <span className="text-[9px] font-semibold uppercase tracking-widest text-white/50">Leak Score</span>
        <span className="text-xl font-bold font-manrope leading-none">68</span>
