...
interface GlowCardProps {
  children?: ReactNode
  className?: string
  /** Hue base for the spotlight glow — defaults to 'orange' to match op-accent */
  glowColor?: 'blue' | 'purple' | 'green' | 'red' | 'orange'
  size?: 'sm' | 'md' | 'lg'
  width?: string | number
  height?: string | number
  /** When true, ignores size prop — use className or width/height for sizing */
  customSize?: boolean
}
...
const glowColorMap = {
  ...
  orange: { base:  30, spread: 200 },  // matches op-accent terracotta
}
    ...
    <>
      ...
      <div
        ...
        className={[
          ...
          'shadow-[0_1rem_2rem_-1rem_rgba(0,0,0,0.8)]',
          'p-5 gap-4 backdrop-blur-sm',
          className,
        ].filter(Boolean).join(' ')}
      >
        <div data-glow />
